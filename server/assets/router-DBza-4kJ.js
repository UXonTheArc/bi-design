...
const appCss = "/assets/styles-t6m-y0IB.css";
const initialState = {
  theme: "system",
  setTheme: () => null
};
...
const $$splitComponentImporter$d = () => import("./voice-and-tone-BERx85l3.js");
const Route$e = createFileRoute("/voice-and-tone")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./typography-DoBScQbh.js");
const Route$d = createFileRoute("/typography")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./target-iokixq-l.js");
const Route$c = createFileRoute("/target")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./standards-CoGawbux.js");
const Route$b = createFileRoute("/standards")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./personas--wIe6whu.js");
const Route$a = createFileRoute("/personas")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./patterns-CfNZsiWK.js");
const Route$9 = createFileRoute("/patterns")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./imagery-CVXIAHw9.js");
const Route$8 = createFileRoute("/imagery")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./identity-BCkmVYh0.js");
const Route$7 = createFileRoute("/identity")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./forms-CpfCPWkH.js");
const Route$6 = createFileRoute("/forms")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./figma-B0r9WLc2.js");
const Route$5 = createFileRoute("/figma")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./elements-B31pY2ER.js");
const Route$4 = createFileRoute("/elements")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-CJGeBEel.js");
...
const $$splitComponentImporter$1 = () => import("./demo.start.server-funcs-TRKkTFiL.js");
